...
<body>
    ...
    <div class="main">
        ...
        <label for="toggle-checkbox" id="toggle-modif"><i class="fa-solid fa-pen-to-square" style="color: #ffffff;"></i></label>
        ...
        <div id="extra-fields">
            <form action="" method="POST">
                ...
                <input type="date" id="date_naissance" name="date_naissance" value="<?php echo $joueur->getDate_de_naissance(); ?>">
